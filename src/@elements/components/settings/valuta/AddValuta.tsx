...
const AddValuta = ({ setOpen, refetch }: Props) => {
  ...
  const onSubmit: SubmitHandler<FormTypes> = async data => {
    try {
      await axiosInstance.post<TPostCurrencyResponse>(`/currencies/`, data)
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <FormControlLabel
          label={t('basic') ?? ''}
          control={<Checkbox {...register('main')} size='small' defaultChecked name='main' />}
        />
